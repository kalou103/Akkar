...
public class ClientService implements IClientService{
    ...
    public Client login(String username, String password) {
        Client user = (Client) userRepository.findClientByEmail(username);
        if (user == null) {
    ...
    public String passwordreset (@PathVariable("login") String login) {
        ...
        Client client= userRepository.findClientByEmail(login);
    ...
    @Override
    public String GetOfferbysearch(TransportationArea area, TransportationType type, double prix, DriverLocation location) {
        return null;
    }
